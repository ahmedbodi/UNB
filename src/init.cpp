...
std::string HelpMessage(HelpMessageMode hmm)
{
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 9444 or testnet: 19444)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 9537 or testnet: 19537)") + "\n";
