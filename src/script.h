...
#ifndef H_VOXELS_SCRIPT
#define H_VOXELS_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CVoxelsAddress
 */
...
public:
    ...
    // Pre-version-0.6, Voxels always counted CHECKMULTISIGs
