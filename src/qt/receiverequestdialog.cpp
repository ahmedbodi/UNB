...
#include "voxels-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatVoxelsURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + VoxelsUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatVoxelsURI(info));
}
