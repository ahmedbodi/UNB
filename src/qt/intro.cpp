...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/voxels"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Voxels"),
     ...
     * override -datadir in the voxels.conf file in the default data directory
     * (to be consistent with voxelsd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
