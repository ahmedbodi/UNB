...
#ifndef _VOXELSRPC_CLIENT_H_
#define _VOXELSRPC_CLIENT_H_ 1
...
/** Show help message for voxels-cli.
 ...
 *
 * @note the argument can be removed once voxels-cli functionality is removed from voxelsd
 */
