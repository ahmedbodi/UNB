Voxels Core version 0.9.4 is now available from:

  https://voxels.org/bin/0.9.4/
...
installer (on Windows) or just copy over /Applications/Voxels-Qt (on Mac) or
voxelsd/voxels-qt (on Linux).
...
this update is incompatible with the Voxels system and could lead to consensus
forks.

Voxels Core released binaries from https://voxels.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~voxels/+archive/ubuntu/voxels
- A third-party or self-compiled Voxels Core

upgrade to Voxels Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/voxels/).
