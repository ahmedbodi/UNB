Voxels version 0.5.4 is now available for download at:
http://sourceforge.net/projects/voxels/files/Voxels/voxels-0.5.4/
...
http://gitorious.org/voxels/voxelsd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Voxels-Qt notifications under Growl 1.3.
Increase required age of Voxels-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxVoxels properly when installing Voxels-Qt over it. (Windows)
