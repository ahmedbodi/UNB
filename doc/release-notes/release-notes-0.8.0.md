Voxels-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/voxels/files/Voxels/voxels-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Voxels
...
New/changed settings (command-line or voxels.conf file)
--------------------------------------------------------
