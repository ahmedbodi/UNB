Download URL: https://sourceforge.net/projects/voxels/files/Voxels/voxels-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 VOX fee schedule (users still pay 0.01 VOX per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #voxels00 - #voxels99
