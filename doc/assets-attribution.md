The following is a list of assets used in the voxels source and their proper attribution.
...
* License: MIT
* Site: [https://voxelstalk.org/index.php?topic=15276.0](https://voxelstalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original voxels logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/voxels.icns, src/qt/res/src/voxels.svg,
	src/qt/res/src/voxels.ico, src/qt/res/src/voxels.png,
	src/qt/res/src/voxels_testnet.png, docs/voxels_logo_doxygen.png,
