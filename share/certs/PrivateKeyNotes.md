...
unlocked to sign the Voxels-Qt.app bundle.
...
allowing somebody to distribute a Voxels-Qt.app or voxels-qt-setup.exe with a valid
...
that the voxels-qt.exe file inside the installer had not been tampered with.
